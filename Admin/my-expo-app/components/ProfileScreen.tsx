    ...
    <SafeAreaView className="flex-1 bg-white">   
      ...
      <View className="bg-white px-4 pb-6 pt-4 rounded-b-3xl shadow-sm">
        ...
        <View className="flex-row items-center justify-between">
          ...
          <TouchableOpacity onPress={() => navigation.navigate("Settings")} className="w-2 h-2 mr-7 bg-white rounded-2xl justify-center items-center shadow-sm border border-gray-200">
      ...
      {/* SCROLL CONTENT STARTS AFTER WHITE HEADER */}
      <ScrollView
        className="px-4 bg-[#F6F8FF]"  
